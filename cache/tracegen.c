...
extern void registerFunctions(); // external function from trans.c
volatile char MARKER_START, MARKER_END; // markers used to bound trace regions of interest
...
int main(int argc, char *argv[]) {
    ...
    registerFunctions(); // register transpose functions    
